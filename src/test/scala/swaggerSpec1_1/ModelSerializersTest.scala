...
class ApiDescriptionSerializersTest extends FlatSpec with ShouldMatchers {
    ...
    json.extract[ApiDescription] match {
      case p: ApiDescription => {
        ...
        p.operations.foreach(op => {
          ...
          op.mobileSDK should be ("the mobileSDK")
  ...
  it should "serialize an ApiDescription" in {
    ...
    write(l) should be ("""{"path":"/foo/bar","description":"the description","operations":[{"method":"get","summary":"the summary","mobileSDK":"the mobileSDK","notes":"the notes","responseClass":"string","nickname":"getMeSomeStrings","parameters":[{"name":"id","description":"the id","defaultValue":"-1","required":false,"allowMultiple":true,"dataType":"string","allowableValues":{"valueType":"LIST","values":["a","b","c"]},"paramType":"query"}]}]}""")
  }
}
...
class OperationSerializersTest extends FlatSpec with ShouldMatchers {
  ...
  it should "serialize an operation" in {
    ...
    write(op) should be ("""{"method":"get","summary":"the summary","mobileSDK":"the mobileSDK","notes":"the notes","responseClass":"string","nickname":"getMeSomeStrings","parameters":[{"name":"id","description":"the id","defaultValue":"-1","required":false,"allowMultiple":true,"dataType":"string","allowableValues":{"valueType":"LIST","values":["a","b","c"]},"paramType":"query"}]}""")
  }
}
