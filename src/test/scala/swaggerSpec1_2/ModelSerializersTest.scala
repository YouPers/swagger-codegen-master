...
class ApiDescriptionSerializersTest extends FlatSpec with ShouldMatchers {
  ...
  it should "serialize an ApiDescription" in {
    ...
    write(l) should be ("""{"path":"/foo/bar","description":"the description","operations":[{"method":"get","summary":"the summary","mobileSDK":"the mobileSDK","notes":"the notes","type":"string","nickname":"getMeSomeStrings","parameters":[{"name":"id","description":"the id","defaultValue":"-1","required":false,"allowMultiple":true,"type":"string","paramType":"query","enum":["a","b","c"]}]}]}""")
  }
}
...
"""
  ...
  it should "serialize an operation" in {
    ...
    write(op) should be ("""{"method":"get","summary":"the summary","mobileSDK":"the mobileSDK","notes":"the notes","type":"string","nickname":"getMeSomeStrings","parameters":[{"name":"id","description":"the id","defaultValue":"-1","required":false,"allowMultiple":true,"type":"string","paramType":"query","enum":["a","b","c"]}]}""")
  }
