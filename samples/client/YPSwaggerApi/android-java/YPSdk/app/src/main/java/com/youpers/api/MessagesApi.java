...
import com.youpers.model.Message;
import java.util.*;
...
public class MessagesApi {
  ...
  public Message getMessageById (String id, String populate) throws ApiException {
    // verify required params are set
    if(id == null ) {
       throw new ApiException(400, "missing required params");
    }
    // create path and map variables
    String path = "/messages/{id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
  ...
  public List<Message> getMessages (String sort, Integer limit, String filter, String populate, String populatedeep, Boolean administrate, Boolean campaign) throws ApiException {
    // create path and map variables
  ...
  public Message postMessages (Message body) throws ApiException {
    // verify required params are set
    if(body == null ) {
       throw new ApiException(400, "missing required params");
    }
