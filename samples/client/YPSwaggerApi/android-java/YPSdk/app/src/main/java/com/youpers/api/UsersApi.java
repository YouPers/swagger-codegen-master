...
import com.youpers.model.UsernameEmail;
...
public class UsersApi {
  ...
  public void validateUser (UsernameEmail body) throws ApiException {
    // verify required params are set
    if(body == null ) {
       throw new ApiException(400, "missing required params");
    }
    // create path and map variables
    String path = "/users/validate".replaceAll("\\{format\\}","json");
  ...
  public void avatarImagePost (String id, String body) throws ApiException {
    // verify required params are set
    if(id == null || body == null ) {
       throw new ApiException(400, "missing required params");
    }
    // create path and map variables
    String path = "/users/{id}/avatar".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
  ...
  public User getUserById (String id, String populate, String populatedeep) throws ApiException {
    // verify required params are set
    if(id == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  public List<User> getUsers (String sort, Integer limit, String filter, String populate, String populatedeep) throws ApiException {
    // create path and map variables
  ...
  public User putUserById (String id, User body) throws ApiException {
    // verify required params are set
    if(id == null || body == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  public User postUser (User body, String password) throws ApiException {
    // verify required params are set
    if(body == null ) {
       throw new ApiException(400, "missing required params");
    }
