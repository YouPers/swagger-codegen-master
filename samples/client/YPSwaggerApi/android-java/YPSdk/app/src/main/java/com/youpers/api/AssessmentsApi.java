...
public class AssessmentsApi {
  ...
  public void postAssessment (AssessmentResult body) throws ApiException {
    // verify required params are set
    if(body == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  public void postAssessmentQuestion (AssessmentQuestion body) throws ApiException {
    // verify required params are set
    if(body == null ) {
       throw new ApiException(400, "missing required params");
    }
    // create path and map variables
    String path = "/assessments/{assessmentId}/questions".replaceAll("\\{format\\}","json");
  ...
  public void deleteAssessmentQuestions (String assessmentId) throws ApiException {
    // verify required params are set
    if(assessmentId == null ) {
       throw new ApiException(400, "missing required params");
    }
    // create path and map variables
    String path = "/assessments/{assessmentId}/questions".replaceAll("\\{format\\}","json").replaceAll("\\{" + "assessmentId" + "\\}", apiInvoker.escapeString(assessmentId.toString()));
