...
-(NSNumber*) getOrderByIdWithCompletionBlockJacopo:(NSString*) orderId
...
-(NSNumber*) deleteOrderWithCompletionBlockJacopo:(NSString*) orderId
...
-(NSNumber*) placeOrderWithCompletionBlockJacopo:(SWGOrder*) body
        completionHandler: (void (^)(NSError* error))completionBlock{
